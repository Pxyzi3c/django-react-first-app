...
class JoinRoom(APIView):
    ...
    def post(self, request, format=None):
        ...
        if code != None:
            ...
            return Response({'Bad Request': 'Invalid Room Code! No room found.'}, status=status.HTTP_404_NOT_FOUND)
...
class UpdateRoom(APIView):
    ...
    def patch(self, request, format=None):
        ...
        if serializer.is_valid():
            ...
            if not queryset.exists(): #this logic is similar to 'if not len(room_results) > 0'
